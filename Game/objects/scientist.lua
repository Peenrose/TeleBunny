function joinScientist(uid)
	local joints = {}
	joints.head = love.physics.newRevoluteJoint(    objects["scientist"][uid].torso.body, objects["scientist"][uid].head.body,     settings.window.width/4.89, settings.window.height/1.83, false)
	joints.head2 = love.physics.newRevoluteJoint(   objects["scientist"][uid].torso.body, objects["scientist"][uid].head.body,     settings.window.width/5.98, settings.window.height/1.85, false)
	joints.leftarm = love.physics.newRevoluteJoint( objects["scientist"][uid].torso.body, objects["scientist"][uid].leftarm.body,  settings.window.width/6.23, settings.window.height/1.73, false)
	joints.rightarm = love.physics.newRevoluteJoint(objects["scientist"][uid].torso.body, objects["scientist"][uid].rightarm.body, settings.window.width/4.17, settings.window.height/1.69, false)
	joints.leftleg = love.physics.newRevoluteJoint( objects["scientist"][uid].torso.body, objects["scientist"][uid].leftleg.body,  settings.window.width/5.58, settings.window.height/1.48, false)
	joints.rightleg = love.physics.newRevoluteJoint(objects["scientist"][uid].torso.body, objects["scientist"][uid].rightleg.body, settings.window.width/4.29, settings.window.height/1.5,  false)
	objects["scientist"][uid].joints = joints
end
...
function loadObject(uid)
	...
	scientist.torso = {
		...
		afterload = [[scientist.torso.body:setBullet(true) joinScientist()]],
	}
	scientist.head = {
		...
		click = function() end,
		touching_ground = false,
		afterload = [[scientist.head.body:setBullet(true)]],
	}
	scientist.leftarm = {
		...
		click = function() end,
		touching_ground = false,
		afterload = [[scientist.leftarm.body:setBullet(true)]],
	}
	scientist.rightarm = {
		...
		click = function() end,
		touching_ground = false,
		afterload = [[scientist.rightarm.body:setBullet(true)]],
	}
	scientist.leftleg = {
		...
		click = function() end,
		touching_ground = false,
		afterload = [[scientist.leftleg.body:setBullet(true)]],
	}
	scientist.rightleg = {
		...
		click = function() end,
		touching_ground = false,
		afterload = [[scientist.rightleg.body:setBullet(true)]],
	}
	return scientist
end